function sendData() {
    ...
    nameCurso = document.getElementById("nameCurso").value;
    descripcion = document.getElementById("descripcion").value;
    type = document.getElementById("type").value;

    var data = {id: id, nameCurso: nameCurso, descripcion: descripcion, type: type};
    console.log(data);
...
function cleanDataCurso() {
    ...
    if (type == "1") {
        if (mdlSuccess == "true") {
            ...
            document.getElementById("nameCurso").value = "";
